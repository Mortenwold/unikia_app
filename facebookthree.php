    ...
    <body>
        ...
        <div id ="facebook">
            ...
            if (isset($accessToken)) {
                ...
                echo '<th colspan="2">';
                echo "<a href='" . $linkAddress . "' target='_blank'>Latest Barnas Designlab Post</a>";
                ...
                $getTotalLikesNorge = $fb->get('barnasdesignlab?fields=fan_count');
                $getTotalLikesNorge = $getTotalLikesNorge->getGraphNode()->asArray();

                $getCountry = $fb->get('barnasdesignlab/insights/?metric=page_fans_country');
                ...
                $getCreatedTime = $fb->get('barnasdesignlab/posts?since=' . $sevenDaysFormat . '&until=' . $todayFormat . '&fields=likes.limit(0),created_time,comments.summary(true)');
